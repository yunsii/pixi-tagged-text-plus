 ...
 */
export function combineAllStyles(styles: (TextStyleExtended | undefined)[]): TextStyleExtended {
  return (styles.filter(isDefined) as TextStyleExtended[]).reduce(combineStyles, {})
}

export function convertAttributeValues(attributes: AttributesList): AttributesList {
  ...
  for (const key in attributes) {
    ...
    if (isStringNumber) {
      convertedAttributes[key] = Number.parseFloat(value)
    }
    else {
 ...
 */
export function injectAttributes(attributes: AttributesList = {}, style: TextStyleExtended = {}): TextStyleExtended | undefined {
 ...
 */
export function getStyleForTag(tagName: string, tagStyles: TextStyleSet, attributes: AttributesList = {}): TextStyleExtended | undefined {
 ...
 */
export function tagWithAttributesToStyle(
  /** A TagWithAttributes object that has a tag name matched with any optional attributes. */
  { tagName, attributes }: TagWithAttributes,
  /** Set of tag styles to search. */
  tagStyles: TextStyleSet,
): TextStyleExtended {
  return getStyleForTag(tagName, tagStyles, attributes) as TextStyleExtended
}
 ...
 */
export function getStyleForTags(tags: TagWithAttributes[], tagStyles: TextStyleSet, styleCache: TextStyleSet): TextStyleExtended {
...
export function interpretFontSize(baseFontSize: FontSize, fontSize: FontSize): FontSize {
...
export function mapTagsToStyles(tokens: TagTokens, styles: TextStyleSet, spriteTemplates?: ImageMap): StyledTokens {
...
export function convertDecorationToLineProps(style: TextStyleExtended): TextStyleExtended {
...
export function extractDecorations(style: TextStyleExtended, textBounds: Bounds, fontProperties: IFontMetrics): TextDecorationMetrics[] {
...
export function convertUnsupportedAlignment(align?: Align): AlignClassic | undefined {
  if (align === undefined) {
    return undefined
  }
  switch (align) {
