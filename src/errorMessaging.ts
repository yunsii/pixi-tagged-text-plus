...
import type { ErrorHandler, ErrorMessage, ErrorMessageType } from './types'

function log(type: ErrorMessageType) {
  return (handler?: ErrorHandler, supressConsole = false, target?: PIXI.Sprite) =>
